...
const Index = () => {
  ...
  const categories = [
    { man: 'Petugas Wawancara', woman: 'Sales Girl', name: 'personalContact' },
    { man: 'Fotografer', woman: 'Artis', name: 'aesthetic' },
    { man: 'Wartawan', woman: 'Penyair', name: 'literary' },
    { man: 'Pemain Organ', woman: 'Komponis', name: 'music' },
    {
      man: 'Petugas Palang Merah',
      woman: 'Petugas Kesejahteraan Sosial',
      name: 'socialService',
    },
    { man: 'Petugas Ekspedisi', woman: 'Penyusun Arsip', name: 'clarical' },
    { man: 'Tukang Cat', woman: 'Tukang Bungkus Coklat', name: 'practical' },
    { man: 'Ahli Farmasi', woman: 'Perawat Orang Tua', name: 'medical' },
    { man: 'Petani', woman: 'Petani Bunga', name: 'outdoor' },
    { man: 'Tukang Las', woman: 'Petugas Mesin Sulam', name: 'mecanical' },
    { man: 'Akuntan', woman: 'Pegawai Pajak', name: 'computational' },
    { man: 'Ahli Astronomi', woman: 'Ahli Astronomi', name: 'science' },
  ];
