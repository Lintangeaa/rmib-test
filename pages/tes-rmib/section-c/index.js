...
const Index = () => {
  ...
  const categories = [
    { man: 'Auditor', woman: 'Pegawai Pajak', name: 'computational' },
    ...
    { man: 'Decorator', woman: 'Artis', name: 'aesthetic' },
    { man: 'Pustakawan', woman: 'Penyair', name: 'literary' },
    { man: 'Pramuniaga Took Musik', woman: 'Komponis', name: 'music' },
    {
      man: 'Psikolog Pendidikan',
      woman: 'Petugas Kesejahteraan Sosial',
      name: 'socialService',
    },
    { man: 'Pegawai Kantor', woman: 'Penulis Steno', name: 'clarical' },
    { man: 'Tukang Sepatu', woman: 'Tukang Binatu', name: 'practical' },
    {
      man: 'Ahli Farmasi',
      woman: 'Pelatih Rehabilitasi Pasien',
      name: 'medical',
    },
    { man: 'Supir', woman: 'Petani Bunga', name: 'outdoor' },
    { man: 'Tukang Las', woman: 'Ahli Reparasi Permata', name: 'mecanical' },
  ];
  ...
  const handleNextClick = () => {
    ...
    if (Object.keys(fieldValues).length === 12) {
      ...
      setTimeout(() => {
        setIsLoading(false);
        router.push('/tes-rmib/section-d');
      }, 1000);
    } else {
