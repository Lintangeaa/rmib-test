...
const Index = () => {
  ...
  const categories = [
    { man: 'Pemain Organ', woman: 'Guru Musik', name: 'music' },
    {
      man: 'Kepala Sekolah',
    ...
    {
      man: 'Petugas Pengiriman Barang',
      woman: 'Pegawai Kantor',
      name: 'clarical',
    },
    ...
    { man: 'Petani', woman: 'Peternak', name: 'outdoor' },
    {
      man: 'Pembuat Arloji',
      woman: 'Ahli Reparasi Permata',
      name: 'mecanical',
    },
    ...
    { man: 'Pengarang', woman: 'Wartawan', name: 'literary' },
  ];
