...
const Index = () => {
  ...
  const categories = [
    { man: 'Pengarang', woman: 'Penulis Sandiwara Radio', name: 'literary' },
    { man: 'Pramuniaga Took Musik', woman: 'Pemain Organ', name: 'music' },
    {
      man: 'Penyebar Agama',
      woman: 'Petugas Palang Merah',
      name: 'socialService',
    },
    { man: 'Petugas Pos', woman: 'Juru Ketik', name: 'clarical' },
    { man: 'Tukang Kayu', woman: 'Juru Masak', name: 'practical' },
    { man: 'Dokter Hewan', woman: 'Dokter Hewan', name: 'medical' },
    { man: 'Nelayan', woman: 'Peternak', name: 'outdoor' },
    { man: 'Montir', woman: 'Ahli Kacamata', name: 'mecanical' },
    { man: 'Kasir', woman: 'Pegawai Pajak', name: 'computational' },
    { man: 'Ilmuwan', woman: 'Ahli Biologi', name: 'science' },
    {
      man: 'Sales Asuransi',
      woman: 'Pegawai Rumah Mode',
      name: 'personalContact',
    },
    { man: 'Artis', woman: 'Guru Kesenian', name: 'aesthetic' },
  ];
  ...
  const handleNextClick = () => {
    ...
    if (Object.keys(fieldValues).length === 12) {
      ...
      setTimeout(() => {
        setIsLoading(false);
        router.push('/tes-rmib/section-h');
      }, 1000);
    } else {
